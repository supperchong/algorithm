...
export function registerDebug() {
    class ConfigurationProvider implements vscode.DebugConfigurationProvider {
         ...
         */
        resolveDebugConfigurationWithSubstitutedVariables(folder: WorkspaceFolder | undefined, debugConfig: DebugConfiguration, token?: CancellationToken): ProviderResult<DebugConfiguration> {
    ...
    class TaskProvider implements vscode.TaskProvider {
        ...
        provideTasks() {
            ...
            let tasks = [new vscode.Task({
                type: TaskProvider.TaskType
            }, vscode.TaskScope.Workspace, taskName, TaskProvider.TaskType,
                new vscode.ProcessExecution(nodeBinPath, [
                    debugTaskFilePath,
                    "${file}",
